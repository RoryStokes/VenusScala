...
package explorer{
	...
	/** An individual explorer.
	  ...
	  * @param x the x coordinate of the explorer
	  * @param y the y coordinate of the explorer
	  * @param dir a character representing the current facing direction as a cardinal compass direction (N/S/E/W)
	  */
